            ...
            <div class="col">
                <div class="card">
                    <h3 class="card-header d-flex justify-content-between align-items-center">
                        Data Masyarakat
                        <button class="btn btn-icon btn-primary" type="button" v-b-modal.modalMasyarakat v-on:click="Add">
        ...
        @ok="Save">
            ...
            <form ref="form">
                <div class="form-group">
                    ...
                    <input type="text" v-model="nik" name="nik" class="form-control" id="nik" placeholder="Nik">
                </div>
                <div class="form-group">
                    <label for="nama" class="form-control-label">Nama Masyarakat</label>
